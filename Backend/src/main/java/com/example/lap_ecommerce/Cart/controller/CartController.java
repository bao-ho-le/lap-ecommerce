...
public class CartController {
    ...
    public ResponseEntity<CartResponse> updateQuantity(Authentication authentication, @PathVariable Integer id,
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<CartResponse> deleteItem(Authentication authentication, @PathVariable Integer id) {
        String email = authentication.getName();
